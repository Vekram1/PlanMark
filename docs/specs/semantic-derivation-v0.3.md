# PlanMark Semantic Derivation Policy v0.3

## Status

- Policy ID: `semantic_derivation/v0.3`
- Scope: deterministic rules for deriving Semantic IR from Source IR
- Canonical dependency: `docs/specs/ir-v0.3.md`
- Prior version: `docs/specs/semantic-derivation-v0.2.md`
...
Policy v0.3 makes one material derivation change:

- tasks now derive a canonical completion field from `@status`

This means:

- canonical task meaning now distinguishes active work from canonically completed work
- task completion can stay in `PLAN.md` without relying on task deletion as the only way to retire work
- semantic fingerprints and tracker projections can react deterministically to plan-owned completion changes
...
- Accepted normalized values in v0.3 are:
  - `open`
  - `done`
